...
def test_dqn(args=get_args()):
    ...
    # make environments
    train_envs = SubprocVectorEnv([lambda: make_minigrid_env(args)
                                   for _ in range(args.training_num)])
    test_envs = SubprocVectorEnv([lambda: make_minigrid_env_watch(args)
    ...
    # define model
    net = DQN(args.state_shape[2], args.state_shape[0], args.state_shape[1],
    ...
    log_path = os.path.join(args.logdir, args.task, 'tpdqn', args.exp, str(args.seed), cur_time)
