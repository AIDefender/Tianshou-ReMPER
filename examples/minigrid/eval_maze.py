...
mean_V_loss = np.average(all_V_loss[np.argsort(V_seed_mean)[:1]], axis=0)
...
frame = sns.heatmap(mean_V_loss, cmap = 'rocket_r', vmin=0.2, vmax=0.6, mask=get_mask(mean_V_loss), ax=ax)
